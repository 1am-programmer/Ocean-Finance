  ...
  return (
    <div className="py-10">
      ...
      <div className="flex py-20 gap-10 justify-center items-center">
        <section>
          <Card className="bg-blue-300 w-[500px] py-8 text-center  px-5 ">
            <CardHeader>
            ...
            <CardFooter>
              <Button className="bg-blue-600 w-full">Discover</Button>
            </CardFooter>
          </Card>
        </section>

        <section>
          <Card className="bg-orange-300 w-[500px] py-8 text-center  px-5 ">
            <CardHeader>
            ...
            <CardFooter>
              <Button className="bg-orange-600  w-full">Discover</Button>
            </CardFooter>
          </Card>
        </section>
      </div>
